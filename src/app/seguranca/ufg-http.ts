...
@Injectable()
export class UfgHttp extends HttpClient {
  ...
  public postSemToken<T>(url: string, body: any, options?: any): Observable<T> {
    return this.fazerRequisicaoSemToken<T>(() => super.post<T>(url, body, options));
  }
